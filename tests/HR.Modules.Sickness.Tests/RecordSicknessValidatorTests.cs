...
public class RecordSicknessValidatorTests
{
    private readonly RecordSicknessValidator _validator = new();

    private static RecordSicknessRequest Valid() => new()
    {
    ...
    public void Validate_Fails_When_CompanyId_Is_Empty()
    {
        ...
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(RecordSicknessRequest.CompanyId));
    }
    ...
    public void Validate_Fails_When_EmployeeId_Is_Empty()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(RecordSicknessRequest.EmployeeId));
    }
    ...
    public void Validate_Fails_When_CategoryId_Is_Empty()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(RecordSicknessRequest.CategoryId));
    }
    ...
    public void Validate_Fails_When_StartDate_Is_Default()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(RecordSicknessRequest.StartDate));
    }
    ...
    public void Validate_Fails_When_StartDayPart_Is_Invalid()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(RecordSicknessRequest.StartDayPart));
    }
}
