...
public class ListRequiredDocumentsHandlerTests
{
    ...
    public async Task HandleAsync_Isolates_Results_By_Company()
    {
        ...
        var profileA = PositionProfile.Create(Guid.NewGuid(), companyA, null, "Engineer", null, false, null, null, null, null, null, null, Now);
        var profileB = PositionProfile.Create(Guid.NewGuid(), companyB, null, "Engineer", null, false, null, null, null, null, null, null, Now);
