...
public class GetEmployeeTimelineValidatorTests
{
    ...
    [Fact]
    public void Validate_Fails_When_DateFrom_Is_After_DateTo()
    {
        var validator = new GetEmployeeTimelineValidator();
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(GetEmployeeTimelineRequest.DateTo));
    }

    [Fact]
    public void Validate_Passes_When_DateFrom_Equals_DateTo()
    {
        var validator = new GetEmployeeTimelineValidator();
        var date = new DateOnly(2026, 7, 1);
        var request = ValidRequest() with { DateFrom = date, DateTo = date };
    ...
    [Fact]
    public void Validate_Passes_When_Only_DateFrom_Is_Provided()
    {
        var validator = new GetEmployeeTimelineValidator();
        var request = ValidRequest() with { DateFrom = new DateOnly(2026, 7, 1), DateTo = null };
    ...
    [Fact]
    public void Validate_Passes_When_Only_DateTo_Is_Provided()
    {
        var validator = new GetEmployeeTimelineValidator();
        var request = ValidRequest() with { DateFrom = null, DateTo = new DateOnly(2026, 7, 1) };
