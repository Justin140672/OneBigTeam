...
public class ExportSicknessReportValidatorTests
{
    private readonly ExportSicknessReportValidator _validator = new();

    private static ExportSicknessReportRequest ValidRequest() => new(Guid.NewGuid());
    ...
    public void Should_Have_Error_When_CompanyId_Is_Empty()
    {
        ...
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(ExportSicknessReportRequest.CompanyId));
    }
    ...
    public void Should_Have_Error_When_GroupBy_Is_Invalid()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(ExportSicknessReportRequest.GroupBy));
    }
    ...
    public void Should_Have_Error_When_Format_Is_Invalid()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(ExportSicknessReportRequest.Format));
    }
    ...
    public void Should_Have_Error_When_EndDate_Is_Before_StartDate()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(ExportSicknessReportRequest.EndDate));
    }
}
