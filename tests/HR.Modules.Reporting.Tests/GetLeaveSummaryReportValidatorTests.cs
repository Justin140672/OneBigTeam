...
public class GetLeaveSummaryReportValidatorTests
{
    private readonly GetLeaveSummaryReportValidator _validator = new();

    private static GetLeaveSummaryReportRequest ValidRequest() =>
    ...
    public void Should_Have_Error_When_CompanyId_Is_Empty()
    {
        ...
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(GetLeaveSummaryReportRequest.CompanyId));
    }
    ...
    public void Should_Have_Error_When_GroupBy_Is_Not_A_Defined_Enum_Value()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(GetLeaveSummaryReportRequest.GroupBy));
    }
    ...
    public void Should_Have_Error_When_PolicyYear_Is_Outside_Boundary(int policyYear)
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(GetLeaveSummaryReportRequest.PolicyYear));
    }
}
