...
public class UpdateAssetValidatorTests
{
    ...
    private static UpdateAssetRequest Valid() => new()
    {
    ...
    public void Validate_Fails_When_CompanyId_Is_Empty()
    {
        ...
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(UpdateAssetRequest.CompanyId));
    }
    ...
    public void Validate_Fails_When_Id_Is_Empty()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(UpdateAssetRequest.Id));
    }
    ...
    public void Validate_Fails_When_CategoryId_Is_Empty()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(UpdateAssetRequest.CategoryId));
    }
    ...
    public void Validate_Fails_When_Name_Is_Empty()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(UpdateAssetRequest.Name));
    }
    ...
    public void Validate_Fails_When_Manufacturer_Exceeds_100_Characters()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(UpdateAssetRequest.Manufacturer));
    }
    ...
    public void Validate_Fails_When_Model_Exceeds_100_Characters()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(UpdateAssetRequest.Model));
    }
    ...
    public void Validate_Fails_When_SerialNumber_Exceeds_100_Characters()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(UpdateAssetRequest.SerialNumber));
    }
    ...
    public void Validate_Fails_When_PurchasePrice_Is_Zero()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(UpdateAssetRequest.PurchasePrice));
    }
