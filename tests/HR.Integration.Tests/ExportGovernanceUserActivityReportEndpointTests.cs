...
/// <summary>
/// ADM-08 Governance User Activity report export. Applies the identical policy pair to the GET
/// endpoint — exports must never widen access.
/// </summary>
[Collection("Integration")]
public class ExportGovernanceUserActivityReportEndpointTests
{
    private readonly ApiWebApplicationFactory _factory;

    public ExportGovernanceUserActivityReportEndpointTests(ApiWebApplicationFactory factory) => _factory = factory;

    private static string Url(Guid companyId) =>
        $"/api/companies/{companyId}/reporting/governance/user-activity/export";
    ...
    [InlineData("?format=Csv&fromDate=2026-06-01&toDate=2026-05-01")]
