...
public class ConfirmImportSessionEndpointTests
{
    ...
    public async Task Automatic_Mode_Row_With_Supplied_EmployeeNumber_Fails_Validation_Alone_While_Other_Rows_Succeed()
    {
        ...
        const string csv =
            ...
            "John,Doe,john.doe@example.com,2026-01-01,,1990-01-01,British,Male,Sales,London,Permanent,Software Developer,50000\n" +
            "Jane,Doe,jane.doe@example.com,2026-01-02,EMP-999,1991-02-02,British,Female,Sales,London,Permanent,Software Developer,50000\n";
    ...
    public async Task Automatic_Mode_Confirm_Assigns_Generated_Numbers_To_All_Valid_Rows_In_RowOrder()
    {
        ...
        const string csv =
            "First Name,Last Name,Work Email,Start Date,Employee Number,Date Of Birth,Nationality,Gender,Department,Location,Employment Type,Position Profile,Salary Amount\n" +
            "John,Doe,john.doe@example.com,2026-01-01,,1990-01-01,British,Male,Sales,London,Permanent,Software Developer,50000\n" +
            "Jane,Doe,jane.doe@example.com,2026-01-02,,1991-02-02,British,Female,Sales,London,Permanent,Software Developer,50000\n";
