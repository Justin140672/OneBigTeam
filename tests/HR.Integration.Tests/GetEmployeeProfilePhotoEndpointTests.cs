...
public class GetEmployeeProfilePhotoEndpointTests : IClassFixture<ApiWebApplicationFactory>
{
    private readonly ApiWebApplicationFactory _factory;
    private static readonly Guid ManagerUser = Guid.Parse("cc200001-0000-0000-0000-000000000001");

    public GetEmployeeProfilePhotoEndpointTests(ApiWebApplicationFactory factory)
    {
        _factory = factory;
        Task.Run(async () =>
        {
    ...
    [Fact]
    public async Task Get_Returns_NotFound_When_No_Current_Photo_Exists()
    {
        var companyId  = Guid.NewGuid();
        var employeeId = Guid.NewGuid();
