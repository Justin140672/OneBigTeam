...
/// <summary>ADM-08 Governance Administrative Changes report export. Same policy pair as its GET endpoint.</summary>
[Collection("Integration")]
public class ExportGovernanceAdministrativeChangesReportEndpointTests
{
    private readonly ApiWebApplicationFactory _factory;

    public ExportGovernanceAdministrativeChangesReportEndpointTests(ApiWebApplicationFactory factory) => _factory = factory;

    private static string Url(Guid companyId) =>
        $"/api/companies/{companyId}/reporting/governance/administrative-changes/export";
    ...
    [InlineData("?format=Csv&fromDate=2026-12-01&toDate=2026-01-01")]
