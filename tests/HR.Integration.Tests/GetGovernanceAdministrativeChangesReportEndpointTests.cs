...
/// <summary>ADM-08 Governance Administrative Changes report (GET). Both governance policies required.</summary>
[Collection("Integration")]
public class GetGovernanceAdministrativeChangesReportEndpointTests
{
    private readonly ApiWebApplicationFactory _factory;

    public GetGovernanceAdministrativeChangesReportEndpointTests(ApiWebApplicationFactory factory) => _factory = factory;

    private static string Url(Guid companyId) =>
        $"/api/companies/{companyId}/reporting/governance/administrative-changes";
    ...
    [InlineData("?fromDate=2026-12-01&toDate=2026-01-01")]
