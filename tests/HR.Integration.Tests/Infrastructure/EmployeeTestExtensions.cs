...
/// test-only setters. Mirrors HR.Modules.Employees.Tests.Infrastructure.EmployeeTestExtensions —
/// duplicated here because Employee.Status has a private setter, which InternalsVisibleTo alone
/// does not expose across assemblies.
/// </summary>
