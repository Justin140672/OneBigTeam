...
/// <summary>
/// Page object for the Probation report
/// (/companies/{companyId}/reporting/probation — ProbationReportPage.razor). This page has no
/// ReportFilterPanel or group-by control at all — just five summary stat cards (Current
/// Probation / Due Reviews / Overdue Reviews / Passed / Extended) above the grid, and export via
/// the same SfDropDownButton pattern as the other report pages.
/// </summary>
public sealed class ProbationReportPage(IPage page, string baseUrl)
{
    private const string RowsRenderedSelector = ".e-grid .e-row, .e-grid .e-emptyrow";

    public async Task GoToAsync(Guid companyId)
    {
        await page.GotoAsync($"{baseUrl}/companies/{companyId}/reporting/probation");
