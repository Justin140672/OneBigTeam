...
public class UpdateCompanyValidatorTests
{
    ...
    [Fact]
    public void Validate_Fails_When_Branding_PrimaryColor_Is_Invalid()
    {
        var v = new UpdateCompanyValidator();
        var result = v.Validate(ValidRequest() with
        {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName.Contains("PrimaryColor"));
    }

    [Fact]
    public void Validate_Fails_When_Branding_SecondaryColor_Is_Invalid()
    {
        var v = new UpdateCompanyValidator();
        var result = v.Validate(ValidRequest() with
        {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName.Contains("SecondaryColor"));
    }

    [Fact]
    public void Validate_Fails_When_Branding_AccentColor_Is_Invalid()
    {
        var v = new UpdateCompanyValidator();
        var result = v.Validate(ValidRequest() with
        {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName.Contains("AccentColor"));
    }

    [Fact]
    public void Validate_Passes_When_Branding_Is_Null()
    {
        var v = new UpdateCompanyValidator();
        var result = v.Validate(ValidRequest() with { Branding = null });
        Assert.True(result.IsValid);
    }

    [Fact]
    public void Validate_Passes_With_Valid_Branding()
    {
        var v = new UpdateCompanyValidator();
        var result = v.Validate(ValidRequest() with
        {
