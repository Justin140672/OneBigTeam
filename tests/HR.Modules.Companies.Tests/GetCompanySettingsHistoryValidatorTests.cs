...
public class GetCompanySettingsHistoryValidatorTests
{
    private static GetCompanySettingsHistoryRequest ValidRequest() => new()
    {
    ...
    {
        var validator = new GetCompanySettingsHistoryValidator();
    ...
    public void Validate_Fails_When_CompanyId_Is_Empty()
    {
        ...
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(GetCompanySettingsHistoryRequest.CompanyId));
    }
    ...
    public void Validate_Fails_When_PageNumber_Is_Zero()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(GetCompanySettingsHistoryRequest.PageNumber));
    }
    ...
    public void Validate_Fails_When_PageSize_Is_Zero()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(GetCompanySettingsHistoryRequest.PageSize));
    }
