...
public class UploadSharedCompanyDocumentValidatorTests
{
    private static readonly UploadSharedCompanyDocumentValidator Validator = new();
    ...
    public void Validate_Custom_ReviewFrequency_With_Null_CustomReviewFrequencyMonths_Fails()
    {
        ...
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(UploadSharedCompanyDocumentRequest.CustomReviewFrequencyMonths));
    }
    ...
    public void Validate_ReviewFrequency_Not_None_With_Null_ReviewDate_Fails()
    {
        ...
        Assert.False(result.IsValid);
        Assert.Contains(result.Errors, e => e.PropertyName == nameof(UploadSharedCompanyDocumentRequest.ReviewDate));
    }
