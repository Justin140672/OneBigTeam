...
```powershell
dotnet restore specifications/reviews/2026-09-10/probes/ReviewProbes.csproj
dotnet run --project specifications/reviews/2026-09-10/probes/ReviewProbes.csproj --no-restore
```
