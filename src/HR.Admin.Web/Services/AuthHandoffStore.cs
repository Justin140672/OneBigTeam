...
/// App-local copy of HR.Web.Services.AuthHandoffStore — deliberately duplicated for the same
/// reason SupabaseSessionAccessor is (HR.Web and HR.Admin.Web are separate deployable apps; this
/// class carries no business logic).
///
