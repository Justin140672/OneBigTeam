...
internal sealed class CreatePositionProfileHandler
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            var replay = await _dbContext.TryReplayAsync<IdempotencyRecord, CreatePositionProfileResponse>(scope, precheckKey, fingerprint!, cancellationToken);
        ...
        {
            var outcome = await _dbContext.SaveIdempotentAsync<IdempotencyRecord, CreatePositionProfileResponse>(_dbContext.IdempotencyRecords, 
