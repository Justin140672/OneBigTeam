...
internal sealed class UpdateFutureCompensationRecordValidator : AbstractValidator<UpdateFutureCompensationRecordRequest>
{
    public UpdateFutureCompensationRecordValidator()
    {
