...
internal sealed class Endpoint(ConfirmImportSessionHandler handler, IAuthorizationService authorizationService, ICurrentUser currentUser)
    : Endpoint<ConfirmImportSessionRequest, ConfirmImportSessionResponse>
{
    public override void Configure()
    {
        Post("/api/companies/{companyId:guid}/data-import/sessions/{importSessionId:guid}/confirm");
