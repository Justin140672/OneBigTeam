...
// Note: mirrors UploadImportFile's auth pattern exactly — see that endpoint for the rationale
// behind reusing "employee:manage" until a dedicated data-import permission exists.
internal sealed class Endpoint(ValidateImportSessionHandler handler, IAuthorizationService authorizationService, ICurrentUser currentUser)
    : Endpoint<ValidateImportSessionRequest, ValidateImportSessionResponse>
{
