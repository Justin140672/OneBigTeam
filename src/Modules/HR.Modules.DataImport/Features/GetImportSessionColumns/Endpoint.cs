...
internal sealed class Endpoint(GetImportSessionColumnsHandler handler, IAuthorizationService authorizationService, ICurrentUser currentUser)
    : Endpoint<GetImportSessionColumnsRequest, GetImportSessionColumnsResponse>
{
