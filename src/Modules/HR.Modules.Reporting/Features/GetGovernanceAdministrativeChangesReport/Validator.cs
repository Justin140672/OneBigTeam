...
internal sealed class GetGovernanceAdministrativeChangesReportValidator
    : AbstractValidator<GetGovernanceAdministrativeChangesReportRequest>
{
    public GetGovernanceAdministrativeChangesReportValidator()
    {
