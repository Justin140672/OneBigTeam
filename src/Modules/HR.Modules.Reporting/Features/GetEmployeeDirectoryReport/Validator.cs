...
internal sealed class GetEmployeeDirectoryReportValidator : AbstractValidator<GetEmployeeDirectoryReportRequest>
{
    public GetEmployeeDirectoryReportValidator()
    {
