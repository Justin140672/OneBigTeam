...
internal sealed class ExportGovernanceUserActivityReportValidator
    : AbstractValidator<ExportGovernanceUserActivityReportRequest>
{
    public ExportGovernanceUserActivityReportValidator()
    {
