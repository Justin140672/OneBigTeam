...
internal sealed class GetGovernanceSecurityEventsReportValidator
    : AbstractValidator<GetGovernanceSecurityEventsReportRequest>
{
    public GetGovernanceSecurityEventsReportValidator()
    {
