...
internal sealed class ExportGovernanceSecurityEventsReportValidator
    : AbstractValidator<ExportGovernanceSecurityEventsReportRequest>
{
    public ExportGovernanceSecurityEventsReportValidator()
    {
