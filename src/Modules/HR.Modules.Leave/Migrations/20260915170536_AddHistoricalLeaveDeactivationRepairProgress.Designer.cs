...
namespace HR.Modules.Leave.Migrations
{
    ...
    [Migration("20260915170536_AddHistoricalLeaveDeactivationRepairProgress")]
    partial class AddHistoricalLeaveDeactivationRepairProgress
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HR.Modules.Leave.Domain.LeavePolicyDeactivationOnDeparture", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("leave_policy_deactivations_on_departure", "leave");
                });
            ...
            modelBuilder.Entity("HR.Modules.Leave.Persistence.AuditOutboxEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("audit_outbox", "leave");
                });

            modelBuilder.Entity("HR.Modules.Leave.Persistence.IdempotencyRecord", b =>
                {
                    ...
                    b.ToTable("idempotency_keys", "leave");
                });
