...
namespace HR.Modules.Recruitment.Migrations
{
    ...
    [Migration("20260916125155_AddCandidateDocumentDeletionOperationClaimLease")]
    partial class AddCandidateDocumentDeletionOperationClaimLease
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HR.Modules.Recruitment.Domain.Application", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("CvReviewedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("cv_reviewed_at");

                    b.Property<Guid?>("CvReviewedByUserId")
                        .HasColumnType("uuid")
                    ...
                    b.Property<DateTimeOffset?>("OfferApprovedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("offer_approved_at");

                    b.Property<Guid?>("OfferApprovedByUserId")
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("HR.Modules.Recruitment.Domain.CandidateDocument", b =>
                {
                    ...
                    b.HasIndex("CandidateId", "Kind");

                    b.ToTable("candidate_documents", "recruitment");
                });

            modelBuilder.Entity("HR.Modules.Recruitment.Domain.CandidateDocumentDeletionOperation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("candidate_document_deletion_operations", "recruitment");
                });

            modelBuilder.Entity("HR.Modules.Recruitment.Domain.CandidatePurgeAuditDelivery", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("candidate_purge_audit_deliveries", "recruitment");
                });
            ...
            modelBuilder.Entity("HR.Modules.Recruitment.Domain.Vacancy", b =>
                {
                    ...
                    b.Property<bool>("IsAdvertisedInternally")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                    ...
                    b.HasIndex("CompanyId", "IsAdvertisedInternally", "Status");

                    b.ToTable("vacancies", "recruitment");
                });

            modelBuilder.Entity("HR.Modules.Recruitment.Persistence.IdempotencyRecord", b =>
                {
                    ...
                    b.ToTable("idempotency_keys", "recruitment");
                });
