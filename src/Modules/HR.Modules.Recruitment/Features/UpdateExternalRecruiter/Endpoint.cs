...
internal sealed class Endpoint(UpdateExternalRecruiterHandler handler, ICurrentUser currentUser)
    : Endpoint<UpdateExternalRecruiterRequest, UpdateExternalRecruiterResponse>
{
    public override void Configure()
    {
        Put("/api/companies/{companyId:guid}/external-recruiters/{externalRecruiterId:guid}");
