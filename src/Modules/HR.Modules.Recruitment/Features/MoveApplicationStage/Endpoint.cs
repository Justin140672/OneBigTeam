...
internal sealed class Endpoint(MoveApplicationStageHandler handler, ICurrentUser currentUser)
    : Endpoint<MoveApplicationStageRequest, MoveApplicationStageResponse>
{
    public override void Configure()
    {
        Post("/api/companies/{companyId:guid}/vacancies/{vacancyId:guid}/applications/{applicationId:guid}/move-stage");
