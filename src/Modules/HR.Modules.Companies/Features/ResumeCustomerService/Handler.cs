    ...
    IAuditEventPublisher auditEventPublisher)
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            var replay = await dbContext.TryReplayAsync<IdempotencyRecord, ResumeCustomerServiceResponse>(scope, precheckKey, fingerprint!, cancellationToken);
        ...
        var response = new ResumeCustomerServiceResponse(subscription.CompanyId, subscription.AdminForcedReadOnly);
