...
namespace HR.Modules.Companies.Migrations
{
    ...
    [Migration("20260914170938_AddIdempotencyScopeAndExpiry")]
            ...
            modelBuilder.Entity("HR.Modules.Companies.Domain.CompanySettings", b =>
                {
                    ...
                    b.Property<int?>("DocumentReminderOffsetDays1")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(90)
                        .HasColumnName("document_reminder_offset_days_1");

                    b.Property<int?>("DocumentReminderOffsetDays2")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(30)
                        .HasColumnName("document_reminder_offset_days_2");

                    b.Property<int?>("DocumentReminderOffsetDays3")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(7)
                        .HasColumnName("document_reminder_offset_days_3");

                    b.Property<bool>("DocumentRemindersEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
                    ...
                    b.Property<bool>("ScheduledRemindersEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
            ...
            modelBuilder.Entity("HR.Modules.Companies.Domain.CustomerSubscription", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("LastAppliedStripeEventCreatedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_applied_stripe_event_created_at");

                    b.Property<string>("LastAppliedStripeEventId")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
            ...
            modelBuilder.Entity("HR.Modules.Companies.Domain.PlatformSettings", b =>
                {
                    ...
                    b.Property<decimal>("MinimumMonthlyChargeGbp")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(10, 2)
                        .HasColumnType("numeric(10,2)")
                        .HasDefaultValue(0m)
                    ...
                    b.Property<string>("PricingBandsJson")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasDefaultValue("[]")
            ...
            modelBuilder.Entity("HR.Modules.Companies.Persistence.IdempotencyRecord", b =>
                {
                    ...
                    b.ToTable("idempotency_keys", "companies");
                });
