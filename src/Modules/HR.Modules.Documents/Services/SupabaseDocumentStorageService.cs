...
internal sealed class SupabaseDocumentStorageService : IDocumentStorageService
{
    private readonly HttpClient _httpClient;
    private readonly SupabaseStorageOptions _options;

    public SupabaseDocumentStorageService(HttpClient httpClient, IOptions<SupabaseStorageOptions> options)
    {
