    ...
    : Endpoint<UploadEmployeeProfilePhotoRequest, UploadEmployeeProfilePhotoResponse>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        // Self-service: employees may upload their own profile photo. Otherwise the caller must
        // be authorized to manage employees.
        var isSelfUpload = callerId == request.EmployeeId;
