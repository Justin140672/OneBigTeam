...
internal sealed class Endpoint(GetEmployeeProfilePhotoHandler handler, IAuthorizationService authorizationService, ICurrentUser currentUser)
    : Endpoint<GetEmployeeProfilePhotoRequest, GetEmployeeProfilePhotoResponse>
{
    public override void Configure()
    {
        Get("/api/companies/{companyId:guid}/employees/{employeeId:guid}/profile-photo");
