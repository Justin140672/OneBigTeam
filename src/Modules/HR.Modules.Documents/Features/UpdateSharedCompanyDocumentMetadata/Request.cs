...
// EffectiveDate, ReviewDate, ReviewFrequency. CompanyId/DocumentId are routing identifiers, not
// editable data. There is no way to submit CreatedBy, CreatedAt, or VersionNumber here — the
// request shape itself is the enforcement, not just a runtime check.
