...
internal sealed class SupabaseSupportAttachmentStorageService : ISupportAttachmentStorageService
{
    private readonly HttpClient _httpClient;
    private readonly SupabaseSupportAttachmentStorageOptions _options;

    public SupabaseSupportAttachmentStorageService(HttpClient httpClient, IOptions<SupabaseSupportAttachmentStorageOptions> options)
    {
