...
/// <summary>
/// Provides the set of "current" (non-terminated) employee IDs for a company, as owned by
...
/// not count LeaveBalance rows belonging to terminated employees), without a direct module-to-module
/// reference or database join.
/// </summary>
public interface ICurrentEmployeeReader
{
    /// <summary>
    /// Returns the IDs of every employee in the given company whose status is not Terminated.
    /// </summary>
